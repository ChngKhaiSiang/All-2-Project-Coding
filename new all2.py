...
asksttpage=Frame(ws,bg='light pink')
engsttpage=Frame(ws,bg='light pink')
chisttpage=Frame(ws,bg='light pink')
bahasasttpage=Frame(ws,bg='light pink')
asktranslatepage=Frame(ws,bg='light blue')
translatepage=Frame(ws,bg='light pink')
primarytranslatepage=Frame(ws,bg='light pink')
imagetotextpage=Frame(ws,bg='light pink')
askquizpage=Frame(ws,bg='light blue')
quizpage=Frame(ws,bg='light blue')
engquiz1page=Frame(ws,bg='yellow')
engquiz2page=Frame(ws,bg='yellow')
engquiz3page=Frame(ws,bg='yellow')
engquiz4page=Frame(ws,bg='yellow')
engquiz5page=Frame(ws,bg='yellow')
engquiz6page=Frame(ws,bg='yellow')
engquiz7page=Frame(ws,bg='yellow')
engquiz8page=Frame(ws,bg='yellow')
engquiz9page=Frame(ws,bg='yellow')
engquiz10page=Frame(ws,bg='yellow')
engscorepage=Frame(ws,bg='#00a8f3')
chiquiz1page=Frame(ws,bg='yellow')
chiquiz2page=Frame(ws,bg='yellow')
chiquiz3page=Frame(ws,bg='yellow')
chiquiz4page=Frame(ws,bg='yellow')
chiquiz5page=Frame(ws,bg='yellow')
chiquiz6page=Frame(ws,bg='yellow')
chiquiz7page=Frame(ws,bg='yellow')
chiquiz8page=Frame(ws,bg='yellow')
chiquiz9page=Frame(ws,bg='yellow')
chiquiz10page=Frame(ws,bg='yellow')
chiscorepage=Frame(ws,bg='#00a8f3')
...
mainpagebg=Image.open("mainpagebg.png")
mainpagebg = mainpagebg.resize((1920,1080))
mainpagebg=ImageTk.PhotoImage(mainpagebg)
...
#Main page-----------------------------------------------------------------------------------------------------
Label(mainpage,image=mainpagebg).place(x=0,y=0)
Label(mainpage,text='Welcome',font=('Ink Free',70,'bold'),bg='black',fg='white').place(x=800,y=80)

tts_button = Button(mainpage,text='Text To Speech',font=('Times New Roman',15,'bold'),borderwidth=3,bg='white',fg='black',command=lambda:show_frame(askttspage))
tts_button.place(x=150,y=300,height=80,width=200)
Label(mainpage,image=ttsicon).place(x=100,y=500)

stt_button = Button(mainpage,text='Speech To Text',font=('Times New Roman',15,'bold'),borderwidth=3,bg='white',fg='black',command=lambda:show_frame(asksttpage))
stt_button.place(x=500,y=300,height=80,width=200)
Label(mainpage,image=stticon).place(x=450,y=500)

trans_button = Button(mainpage,text='Translator',font=('Times New Roman',15,'bold'),borderwidth=3,bg='white',fg='black',command=lambda:show_frame(asktranslatepage))
trans_button.place(x=850,y=300,height=80,width=200)
Label(mainpage,image=transicon).place(x=800,y=500)

file_button = Button(mainpage,text='File To Text',font=('Times New Roman',15,'bold'),borderwidth=3,bg='white',fg='black',command=lambda:show_frame(imagetotextpage))
file_button.place(x=1200,y=300,height=80,width=200)
Label(mainpage,image=imagetotexticon).place(x=1150,y=500)

quiz_button = Button(mainpage,text='Learning Quiz',font=('Times New Roman',15,'bold'),borderwidth=3,bg='white',fg='black',command=lambda:show_frame(askquizpage))
quiz_button.place(x=1550,y=300,height=80,width=200)
Label(mainpage,image=quizicon).place(x=1500,y=500)

Button(mainpage,text="Log Out",font=("Times New Roman",20, 'bold'),bd=5,command=backlogin).place(x=80,y=80,height=50,width=150)
#ask tts page-----------------------------------------------------------------------------------------------------------------
...
def engdownload():
    ...
    def setvoice():
        if(gender=='Female'):
            ...
            os.chdir(path)
            engine.save_to_file(text,'newall')
            engine.runAndWait()
        else:
            engine.setProperty('voice',voices[1].id)
            path=filedialog.askdirectory()
...
engtts_entry = Text(engttspage,font=('Times News Roman',15))
...
def download():
    ...
    def setvoice():
        if(gender=='Female'):
            ...
            path=filedialog.askdirectory()
            os.chdir(path)
            engine.save_to_file(text,'All2.mp3')
            engine.runAndWait()
        else:
            engine.setProperty('voice',voices[1].id)
            path=filedialog.askdirectory()
...
tts_entry = Text(ttspage,font=('Times News Roman',15))
...
bahasatts_entry = Entry(bahasattspage,font=('Times News Roman',20))
...
#ask stt page-----------------------------------------------------------------------------------------------------------------
Label(asksttpage,text='Speech To Text',font=('Ink Free',70,'bold'),bg='light pink',fg='white').place(x=680,y=80)
...
#English Stt page--------------------------------------------------------------------------------------------------------------------------------------
Label(engsttpage, text='English',font=('Ink Free',50,'bold'),bg='light pink',fg='white').place(x=800,y=80)
...
engtext = Text(engsttpage,font=('Times New Roman',15,'bold'), height=20, width=150)
...
#Chinese Stt page--------------------------------------------------------------------------------------------------------------------------------------
Label(chisttpage, text='Chinese',font=('Ink Free',50,'bold'),bg='light pink',fg='white').place(x=800,y=80)
...
chitext = Text(chisttpage,font=('Times New Roman',15,'bold'), height=20, width=150)
...
#Malay Stt page--------------------------------------------------------------------------------------------------------------------------------------
Label(bahasasttpage, text='Malay',font=('Ink Free',50,'bold'),bg='light pink',fg='white').place(x=830,y=80)
...
bahasatext = Text(bahasasttpage,font=('Times New Roman',15,'bold'), height=20, width=150)
...
#ask translate page------------------------------------------------------------------------------------------------------------------------------------
Label(asktranslatepage,text='Translator',font=('Ink Free',70,'bold'),bg='light blue',fg='white').place(x=720,y=80)
...
Label(translatepage,text='Translator',font=('Ink Free',40,'bold'),bg='light pink',fg='white').place(x=790,y=80)

text1=Label(translatepage,text='english',font=('Ink Free',30,'bold'),bg='light pink',fg='white')
text1.place(x=300,y=200)

text2=Label(translatepage,text='chinese (simplified)',font=('Ink Free',30,'bold'),bg='light pink',fg='white')
...
input_text=Text(translatepage,height=30,width=80)
input_text.place(x=150,y=350)

output_text=Text(translatepage,height=30,width=80)
...
Label(primarytranslatepage,text='Translator',font=('Ink Free',40,'bold'),bg='light pink',fg='white').place(x=790,y=80)

pritext1=Label(primarytranslatepage,text='English',font=('Ink Free',30,'bold'),bg='light pink',fg='white')
pritext1.place(x=300,y=200)

ptext2=Label(primarytranslatepage,text='English , Chinese , Malay',font=('Ink Free',30,'bold'),bg='light pink',fg='white')
...
poutput_text=Text(primarytranslatepage,font=('Times New Roman',20,'bold'))
...
show2()
#image to text page------------------------------------------------------------------------------------
Label(imagetotextpage,text='Image To Text',font=('Ink Free',40,'bold'),bg='light pink',fg='white').place(x=800,y=80)
...
imagebutton = Button(imagetotextpage, text='start', command=lambda:ptext.insert(END,image()))
imagebutton.place(x=920,y=520,height=100,width=150)

ptext = Text(imagetotextpage, font=12, height=20, width=52)
ptext.place(x=220,y=350,height=480,width=620)

Label(imagetotextpage,bg='white').place(x=1200,y=350,height=480,width=500)

uploadbutton = Button(imagetotextpage, text='upload', command=upload_file)
uploadbutton.place(x=920,y=700,height=100,width=150)

Button(imagetotextpage,text="Back",font=("Times New Roman",20, 'bold'),bd=5,command=backmain).place(x=80,y=80,height=50,width=150)
#ask Quiz Page-----------------------------------------------------------------------------------------------------------------------
...
#english quiz---------------------------------------------------------------------------------------------------------------
Label(engquiz1page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(engquiz1page,text='Quiz 1',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(engquiz1page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
...
def score():
    global counter
    counter +=1
    engscore=Label(engscorepage,text=counter,font=('Times New Roman',40,'bold'),bg='#00a8f3').place(x=900,y=450)
...
Button(engquiz1page,image=play_btn,bg='#00a8f3',bd=5,command=engquiz1).place(x=450,y=450)
       
       
Label(engquiz2page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(engquiz2page,text='Quiz 2',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(engquiz2page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
...
Button(engquiz2page,image=play_btn,bg='#00a8f3',bd=5,command=engquiz2).place(x=450,y=450)

Label(engquiz3page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(engquiz3page,text='Quiz 3',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(engquiz3page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
def score2():
    global counter
    counter +=1
    engscore=Label(engscorepage,text=counter,font=('Times New Roman',40,'bold'),bg='#00a8f3').place(x=900,y=450)
...
Button(engquiz3page,image=play_btn,bg='#00a8f3',bd=5,command=engquiz3).place(x=450,y=450)

Label(engquiz4page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(engquiz4page,text='Quiz 4',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(engquiz4page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
def score3():
    global counter
    counter +=1
    engscore=Label(engscorepage,text=counter,font=('Times New Roman',40,'bold'),bg='#00a8f3').place(x=900,y=450)
...
Button(engquiz4page,image=play_btn,bg='#00a8f3',bd=5,command=engquiz4).place(x=450,y=450)

Label(engquiz5page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(engquiz5page,text='Quiz 5',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(engquiz5page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
def score4():
    global counter
    counter +=1
    engscore=Label(engscorepage,text=counter,font=('Times New Roman',40,'bold'),bg='#00a8f3').place(x=900,y=450)
...
Button(engquiz5page,image=play_btn,bg='#00a8f3',bd=5,command=engquiz5).place(x=450,y=450)

Label(engquiz6page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(engquiz6page,text='Quiz 6',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(engquiz6page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
def score5():
    global counter
    counter +=1
    engscore=Label(engscorepage,text=counter,font=('Times New Roman',40,'bold'),bg='#00a8f3').place(x=900,y=450)
...
Button(engquiz6page,image=play_btn,bg='#00a8f3',bd=5,command=engquiz6).place(x=450,y=450)

Label(engquiz7page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(engquiz7page,text='Quiz 7',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(engquiz7page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
def score6():
    global counter
    counter +=1
    engscore=Label(engscorepage,text=counter,font=('Times New Roman',40,'bold'),bg='#00a8f3').place(x=900,y=450)
...
Button(engquiz7page,image=play_btn,bg='#00a8f3',bd=5,command=engquiz7).place(x=450,y=450)

Label(engquiz8page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(engquiz8page,text='Quiz 8',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(engquiz8page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
def score7():
    global counter
    counter +=1
    engscore=Label(engscorepage,text=counter,font=('Times New Roman',40,'bold'),bg='#00a8f3').place(x=900,y=450)
...
Button(engquiz8page,image=play_btn,bg='#00a8f3',bd=5,command=engquiz8).place(x=450,y=450)

Label(engquiz9page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(engquiz9page,text='Quiz 9',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(engquiz9page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
def score8():
    global counter
    counter +=1
    engscore=Label(engscorepage,text=counter,font=('Times New Roman',40,'bold'),bg='#00a8f3').place(x=900,y=450)
...
Button(engquiz9page,image=play_btn,bg='#00a8f3',bd=5,command=engquiz9).place(x=450,y=450)

Label(engquiz10page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(engquiz10page,text='Quiz 10',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(engquiz10page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
...
Button(engquiz10page,image=play_btn,bg='#00a8f3',bd=5,command=engquiz10).place(x=450,y=450)
#english score page------------------------------------------------------------------------------------------------------------
engscore=Label(engscorepage,text=counter,font=('Times New Roman',40,'bold'),bg='#00a8f3').place(x=900,y=450)
Label(engscorepage,text='Your Score : ',font=('Times New Roman',30,'bold'),bg='#00a8f3').place(x=450,y=450)
Label(engscorepage,text='Nice Try',font=('Ink Free',50,'bold'),bg='#00a8f3').place(x=700,y=100)
Label(engscorepage,image=good,bg='#00a8f3').place(x=1000,y=90)
def saveengscore():
    try:
        con=pymysql.connect(host='localhost',user='root',password='',database='users_form')
        cursor=con.cursor()
...
#Chinese Quiz-------------------------------------------------------------------------------------------------------------
Label(chiquiz1page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(chiquiz1page,text='Quiz 1',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(chiquiz1page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
global counter1
counter1=0
def score10():
    global counter1
    counter1 +=1
    chiscore=Label(chiscorepage,text=counter1,font=('Times New Roman',40,'bold'),bg='#00a8f3').place(x=900,y=450)
...
Button(chiquiz1page,image=play_btn,bg='#00a8f3',bd=5,command=chiquiz1).place(x=450,y=450)

Label(chiquiz2page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(chiquiz2page,text='Quiz 2',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(chiquiz2page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
...
Button(chiquiz2page,image=play_btn,bg='#00a8f3',bd=5,command=chiquiz2).place(x=450,y=450)

Label(chiquiz3page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(chiquiz3page,text='Quiz 3',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(chiquiz3page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
...
Button(chiquiz3page,image=play_btn,bg='#00a8f3',bd=5,command=chiquiz3).place(x=450,y=450)

Label(chiquiz4page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(chiquiz4page,text='Quiz 4',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(chiquiz4page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
...
Button(chiquiz4page,image=play_btn,bg='#00a8f3',bd=5,command=chiquiz4).place(x=450,y=450)

Label(chiquiz5page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(chiquiz5page,text='Quiz 5',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(chiquiz5page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
def score14():
    global counter1
    counter1 +=1
    chiscore=Label(chiscorepage,text=counter1,font=('Times New Roman',40,'bold'),bg='#00a8f3').place(x=900,y=450)
...
Button(chiquiz5page,image=play_btn,bg='#00a8f3',bd=5,command=chiquiz5).place(x=450,y=450)

Label(chiquiz6page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(chiquiz6page,text='Quiz 6',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(chiquiz6page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
...
Button(chiquiz6page,image=play_btn,bg='#00a8f3',bd=5,command=chiquiz6).place(x=450,y=450)

Label(chiquiz7page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(chiquiz7page,text='Quiz 7',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(chiquiz7page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
...
Button(chiquiz7page,image=play_btn,bg='#00a8f3',bd=5,command=chiquiz7).place(x=450,y=450)

Label(chiquiz8page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(chiquiz8page,text='Quiz 8',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(chiquiz8page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
...
Button(chiquiz8page,image=play_btn,bg='#00a8f3',bd=5,command=chiquiz8).place(x=450,y=450)

Label(chiquiz9page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(chiquiz9page,text='Quiz 9',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(chiquiz9page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
...
Button(chiquiz9page,image=play_btn,bg='#00a8f3',bd=5,command=chiquiz9).place(x=450,y=450)

Label(chiquiz10page,bg='#00a8f3').place(x=100,y=50,height=160,width=1700)
Label(chiquiz10page,text='Quiz 10',font=('Ink Free',50,'bold'),bg='#00a8f3',fg='white').place(x=850,y=80)
Label(chiquiz10page,bg='#00a8f3').place(x=100,y=250,height=750,width=1700)
...
Button(chiquiz10page,image=play_btn,bg='#00a8f3',bd=5,command=chiquiz10).place(x=450,y=450)
#chinese score page-------------------------------------------------------------------------------------------------------------
chiscore=Label(chiscorepage,text=counter1,font=('Times New Roman',40,'bold'),bg='#00a8f3').place(x=900,y=450)
Label(chiscorepage,text='Your Score : ',font=('Times New Roman',30,'bold'),bg='#00a8f3').place(x=450,y=450)
Label(chiscorepage,text='Nice Try',font=('Ink Free',50,'bold'),bg='#00a8f3').place(x=700,y=100)
Label(chiscorepage,image=good,bg='#00a8f3').place(x=1000,y=90)
def savechiscore():
    try:
        con=pymysql.connect(host='localhost',user='root',password='',database='users_form')
        cursor=con.cursor()
